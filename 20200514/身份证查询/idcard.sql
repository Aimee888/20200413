...
--
-- Host: localhost
-- Generation Time: 2019-07-02 18:04:41
-- 服务器版本： 5.6.44-log
-- PHP Version: 7.0.33
...
CREATE TABLE `fgws_idcard` (
  `id` int(11) UNSIGNED NOT NULL COMMENT '区号',
  `name` varchar(255) NOT NULL COMMENT '名称'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='身份证区域识别表';

--
-- 转存表中的数据 `fgws_idcard`
--

INSERT INTO `fgws_idcard` (`id`, `name`) VALUES
(110000, '北京市'),
(110100, '北京市市辖区'),
(110101, '北京市东城区'),
(110102, '北京市西城区'),
...
--
-- Indexes for table `fgws_idcard`
--
ALTER TABLE `fgws_idcard`
  ADD PRIMARY KEY (`id`);
...
--
-- 使用表AUTO_INCREMENT `fgws_idcard`
--
ALTER TABLE `fgws_idcard`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '区号', AUTO_INCREMENT=659002;
COMMIT;
